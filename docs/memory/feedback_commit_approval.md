...
**2026-05-27 재위반 사례:** 사용자가 `.bat` 추가를 "진행"하라고 승인했지만, 별도 커밋 승인은 하지 않았다. 구현 진행 승인과 커밋 승인은 분리해서 해석해야 한다. 커밋 직전에는 항상 대상 파일과 커밋 메시지를 보여주고 "커밋해도 될까요?"를 물은 뒤 명시적 답변을 받아야 한다.
